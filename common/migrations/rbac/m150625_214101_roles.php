...
class m150625_214101_roles extends Migration
{
    ...
    public function up()
    {
        ...
        $user = $this->auth->createRole(User::ROLE_EMPLOYEE);
        $this->auth->add($user);

        $manager = $this->auth->createRole(User::ROLE_HR_MANAGER);
    ...
    public function down()
    {
        ...
        $this->auth->remove($this->auth->getRole(User::ROLE_HR_MANAGER));
        $this->auth->remove($this->auth->getRole(User::ROLE_EMPLOYEE));
    }
}
