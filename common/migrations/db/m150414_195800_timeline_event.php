    ...
    public function safeUp()
    {
        ...
        $this->batchInsert(
            ...
            [
                ...
                ['frontend', 'user', 'signup', json_encode(['public_identity' => 'hr_manager', 'user_id' => 2, 'created_at' => time()]), time()],
                ['frontend', 'user', 'signup', json_encode(['public_identity' => 'employee', 'user_id' => 3, 'created_at' => time()]), time()]
            ]
        );
    }
