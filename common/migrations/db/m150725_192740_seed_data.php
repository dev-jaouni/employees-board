...
class m150725_192740_seed_data extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('{{%user}}', [
            ...
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('hr_manager'),
            'auth_key' => Yii::$app->getSecurity()->generateRandomString(),
            'access_token' => Yii::$app->getSecurity()->generateRandomString(40),
            'status' => User::STATUS_ACTIVE,
            'created_at' => time(),
        ...
        $this->insert('{{%widget_menu}}', [
            ...
            'items' => json_encode([
                ...
                [
                    'label' => 'Employees Board on GitHub',
                    'url' => 'https://github.com/dev-jaouni/employees-board',
                    'options' => ['tag' => 'span'],
                    'template' => '<a href="{url}" class="btn btn-lg btn-primary">{label}</a>'
                ],
                [
                    'label' => 'Find a bug?',
                    'url' => 'https://github.com/dev-jaouni/employees-board/issues',
                    'options' => ['tag' => 'span'],
        ...
        $this->insert('{{%widget_text}}', [
            ...
            'body' => '<p>Welcome to Employees Board Dashboard</p>',
            'status' => 1,
            'created_at' => time(),
            'updated_at' => time(),
        ]);
