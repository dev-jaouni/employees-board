...
<div class="user-profile-form">
    ...
    <div class="row">
        <div class="col">
            <?php echo $form->field($model->getModel('profile'), 'first_name')->textInput(['maxlength' => 255]) ?>
        </div>
        <div class="col">
            <?php echo $form->field($model->getModel('profile'), 'middle_name')->textInput(['maxlength' => 255]) ?>
        </div>
        <div class="col">
            <?php echo $form->field($model->getModel('profile'), 'last_name')->textInput(['maxlength' => 255]) ?>
        </div>
    </div>
